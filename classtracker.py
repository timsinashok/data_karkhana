...
class Tracker:
    def __init__(self, host, port):
        ...
        self.peers = {}
        #self.peers = {'receiver1': ('172.26.84.74', 12345), 'receiver3': ('172.24.112.1', 56964), 'sender': ('172.26.87.139', 8001)}
        self.files = {}
    #     self.files = {
    #     "file.txt":{
    #         'file_0.txt': ['172.26.84.74', 12345], 
    #         'file_1.txt': ['172.26.84.74', 12345]
    #     }
    # }
    ...
    def _share_file(self, data, conn):
        ...
        for receiver_peer_id, (receiver_ip, receiver_port) in self.peers.items():
            if receiver_ip != sender_ip or receiver_port != sender_port:
                ...
                self.files[file_name][file + "-" + str(chunk_number) + '.txt'] = [receiver_ip, receiver_port]
...
if __name__ == "__main__":
    tracker_host = "172.20.10.7"  # Replace with the actual IP address of the tracker machine
    tracker_port = 12346
